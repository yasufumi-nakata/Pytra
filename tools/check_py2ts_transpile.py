#!/usr/bin/env python3
"""Check py2ts transpile success for fixtures and sample files."""
...
def main() -> int:
    ap = argparse.ArgumentParser(description="check py2ts transpile success for fixtures/sample")
