...
Reads work/parity-results/*.json and fixture/sample lists, then writes:
  docs/ja/language/backend-progress-fixture.md
  docs/ja/language/backend-progress-sample.md
  docs/ja/language/backend-progress-selfhost.md
  docs/en/language/backend-progress-fixture.md
  docs/en/language/backend-progress-sample.md
  docs/en/language/backend-progress-selfhost.md

Note: docs/{ja,en}/language/progress.md is the hand-written cushion page
...
def main() -> int:
    ...
    ja_dir = ROOT / "docs" / "ja" / "language"
    en_dir = ROOT / "docs" / "en" / "language"
