#!/usr/bin/env python3
"""Check py2java transpile success for fixtures and sample files."""
...
def main() -> int:
    ap = argparse.ArgumentParser(description="check py2java transpile success for fixtures/sample")
