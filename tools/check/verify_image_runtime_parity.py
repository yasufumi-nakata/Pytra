...
- C++ runtimes: src/runtime/east/utils/png.cpp, src/runtime/east/utils/gif.cpp
...
#include "runtime/east/utils/png.h"
#include "runtime/east/utils/gif.h"
...
def _build_and_run_cpp(work: Path, out_png: Path, out_gif: Path) -> None:
    ...
    cmd_compile = [
        ...
        "src/runtime/east/utils/gif.cpp",
