    ...
    while (t < __pytra_int(frames_n)) {
        ...
        while (y < __pytra_int(h)) {
            ...
            while (x < __pytra_int(w)) {
                var dx: Long = (x - 160L)
                var dy: Long = (y - 120L)
                var v: Double = __pytra_float(((kotlin.math.sin(__pytra_float((__pytra_float(x) + (__pytra_float(t) * 2.0)) * 0.045)) + kotlin.math.sin(__pytra_float((__pytra_float(y) - (__pytra_float(t) * 1.2)) * 0.05))) + kotlin.math.sin(__pytra_float((__pytra_float(x + y) + (__pytra_float(t) * 1.7)) * 0.03))) + kotlin.math.sin(__pytra_float((kotlin.math.sqrt(__pytra_float((dx * dx) + (dy * dy))) * 0.07) - (__pytra_float(t) * 0.18))))
