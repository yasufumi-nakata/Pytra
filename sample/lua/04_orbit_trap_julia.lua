    ...
    for y = 0, (height) - 1, 1 do
        ...
        for x = 0, (width) - 1, 1 do
            ...
            if (i >= max_iter) then
                ...
                local tone = (math.floor(tonumber((255.0 * (1.0 - trap_scaled))) or 0))
                r = (math.floor(tonumber((tone * (0.35 + (0.65 * t)))) or 0))
                g = (math.floor(tonumber((tone * (0.15 + (0.85 * (1.0 - t))))) or 0))
                b = (math.floor(tonumber((255.0 * (0.25 + (0.75 * t)))) or 0))
                if (r > 255) then
                    r = 255
                end
                if (g > 255) then
