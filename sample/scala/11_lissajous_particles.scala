...
def color_palette(): mutable.ArrayBuffer[Any] = {
...
def run_11_lissajous_particles(): Unit = {
    ...
    boundary:
        given __breakLabel_0: boundary.Label[Unit] = summon[boundary.Label[Unit]]
        val __step_2 = __pytra_int(1L)
        while ((__step_2 >= 0L && t < __pytra_int(frames_n)) || (__step_2 < 0L && t > __pytra_int(frames_n))) {
            boundary:
                given __continueLabel_1: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                var frame: mutable.ArrayBuffer[Any] = __pytra_as_list(__pytra_bytearray((__pytra_int(w) * __pytra_int(h))))
                var __hoisted_cast_1: Double = __pytra_float(__pytra_float(t))
                var p: Long = __pytra_int(0L)
                boundary:
                    given __breakLabel_3: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                    val __step_5 = __pytra_int(1L)
                    while ((__step_5 >= 0L && p < __pytra_int(particles)) || (__step_5 < 0L && p > __pytra_int(particles))) {
                        boundary:
                            ...
                            var x: Long = __pytra_int(__pytra_int(((__pytra_float(w) * __pytra_float(0.5)) + ((__pytra_float(w) * __pytra_float(0.38)) * scala.math.sin(__pytra_float((__pytra_float((__pytra_float(0.11) * __pytra_float(__hoisted_cast_1))) + __pytra_float((__pytra_float(phase) * __pytra_float(2.0))))))))))
                            var y: Long = __pytra_int(__pytra_int(((__pytra_float(h) * __pytra_float(0.5)) + ((__pytra_float(h) * __pytra_float(0.38)) * scala.math.sin(__pytra_float((__pytra_float((__pytra_float(0.17) * __pytra_float(__hoisted_cast_1))) + __pytra_float((__pytra_float(phase) * __pytra_float(3.0))))))))))
                            var color: Long = __pytra_int((__pytra_int(30L) + __pytra_int((__pytra_int((__pytra_int(p) * __pytra_int(9L))) % __pytra_int(220L)))))
                            var dy: Long = __pytra_int((-2L))
                            boundary:
                                given __breakLabel_6: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                                val __step_8 = __pytra_int(1L)
                                while ((__step_8 >= 0L && dy < __pytra_int(3L)) || (__step_8 < 0L && dy > __pytra_int(3L))) {
                                    boundary:
                                        given __continueLabel_7: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                                        var dx: Long = __pytra_int((-2L))
                                        boundary:
                                            given __breakLabel_9: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                                            val __step_11 = __pytra_int(1L)
                                            while ((__step_11 >= 0L && dx < __pytra_int(3L)) || (__step_11 < 0L && dx > __pytra_int(3L))) {
                                                boundary:
