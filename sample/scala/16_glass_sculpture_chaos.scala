...
def length(x: Double, y: Double, z: Double): Double = {
    return __pytra_float(scala.math.sqrt(__pytra_float((__pytra_float((__pytra_float((__pytra_float(x) * __pytra_float(x))) + __pytra_float((__pytra_float(y) * __pytra_float(y))))) + __pytra_float((__pytra_float(z) * __pytra_float(z)))))))
}
...
def normalize(x: Double, y: Double, z: Double): mutable.ArrayBuffer[Any] = {
    ...
    return __pytra_as_list(mutable.ArrayBuffer[Any]((__pytra_float(x) / __pytra_float(l)), (__pytra_float(y) / __pytra_float(l)), (__pytra_float(z) / __pytra_float(l))))
}
...
def reflect(ix: Double, iy: Double, iz: Double, nx: Double, ny: Double, nz: Double): mutable.ArrayBuffer[Any] = {
    ...
    return __pytra_as_list(mutable.ArrayBuffer[Any]((__pytra_float(ix) - __pytra_float((__pytra_float(d) * __pytra_float(nx)))), (__pytra_float(iy) - __pytra_float((__pytra_float(d) * __pytra_float(ny)))), (__pytra_float(iz) - __pytra_float((__pytra_float(d) * __pytra_float(nz))))))
}
...
def refract(ix: Double, iy: Double, iz: Double, nx: Double, ny: Double, nz: Double, eta: Double): mutable.ArrayBuffer[Any] = {
    ...
    var cost: Double = __pytra_float(scala.math.sqrt(__pytra_float((__pytra_float(1.0) - __pytra_float(sint2)))))
    var k: Double = __pytra_float(((__pytra_float(eta) * __pytra_float(cosi)) - cost))
    return __pytra_as_list(mutable.ArrayBuffer[Any](((__pytra_float(eta) * __pytra_float(ix)) + (k * nx)), ((__pytra_float(eta) * __pytra_float(iy)) + (k * ny)), ((__pytra_float(eta) * __pytra_float(iz)) + (k * nz))))
}
...
def sky_color(dx: Double, dy: Double, dz: Double, tphase: Double): mutable.ArrayBuffer[Any] = {
    ...
    var band: Double = __pytra_float((0.5 + (0.5 * scala.math.sin(__pytra_float((__pytra_float((__pytra_float((__pytra_float(8.0) * __pytra_float(dx))) + __pytra_float((__pytra_float(6.0) * __pytra_float(dz))))) + __pytra_float(tphase)))))))
    r += (0.08 * band)
    g += (0.05 * band)
    b += (0.12 * band)
...
def palette_332(): mutable.ArrayBuffer[Any] = {
    var p: mutable.ArrayBuffer[Any] = __pytra_as_list(__pytra_bytearray((__pytra_int(256L) * __pytra_int(3L))))
    ...
    boundary:
        ...
        while ((__step_2 >= 0L && i < __pytra_int(256L)) || (__step_2 < 0L && i > __pytra_int(256L))) {
            boundary:
...
def render_frame(width: Long, height: Long, frame_id: Long, frames_n: Long): mutable.ArrayBuffer[Any] = {
    ...
    boundary:
        ...
        while ((__step_5 >= 0L && py < __pytra_int(height)) || (__step_5 < 0L && py > __pytra_int(height))) {
            boundary:
                ...
                boundary:
                    ...
                    while ((__step_8 >= 0L && px < __pytra_int(width)) || (__step_8 < 0L && px > __pytra_int(width))) {
                        boundary:
                            ...
                            if ((__pytra_int(hit_kind) == __pytra_int(0L))) {
                                ...
                                if ((__pytra_int(hit_kind) == __pytra_int(1L))) {
                                    ...
                                    var cx: Long = __pytra_int(__pytra_int(scala.math.floor(__pytra_float((hx * 2.0)))))
                                    var cz: Long = __pytra_int(__pytra_int(scala.math.floor(__pytra_float((hz * 2.0)))))
                                    ...
                                    var hz: Double = __pytra_float((cam_z + (best_t * dz)))
                                    val __tuple_12 = __pytra_as_list(normalize((__pytra_float((hx - cx)) / __pytra_float(rad)), (__pytra_float((hy - cy)) / __pytra_float(rad)), (__pytra_float((hz - cz)) / __pytra_float(rad))))
                                    ...
                                    val __tuple_14 = __pytra_as_list(refract(dx, dy, dz, nx, ny, nz, (__pytra_float(1.0) / __pytra_float(1.45))))
...
def run_16_glass_sculpture_chaos(): Unit = {
    ...
    boundary:
        given __breakLabel_0: boundary.Label[Unit] = summon[boundary.Label[Unit]]
        val __step_2 = __pytra_int(1L)
        while ((__step_2 >= 0L && i < __pytra_int(frames_n)) || (__step_2 < 0L && i > __pytra_int(frames_n))) {
            boundary:
                given __continueLabel_1: boundary.Label[Unit] = summon[boundary.Label[Unit]]
