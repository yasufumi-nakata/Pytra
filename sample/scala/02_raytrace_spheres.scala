                    ...
                    while ((__step_5 >= 0L && x < __pytra_int(width)) || (__step_5 < 0L && x > __pytra_int(width))) {
                        boundary:
                            ...
                            boundary:
                                ...
                                while ((__step_8 >= 0L && ay < __pytra_int(aa)) || (__step_8 < 0L && ay > __pytra_int(aa))) {
                                    boundary:
                                        ...
                                        boundary:
                                            ...
                                            while ((__step_11 >= 0L && ax < __pytra_int(aa)) || (__step_11 < 0L && ax > __pytra_int(aa))) {
                                                boundary:
                                                    ...
                                                    var inv_len: Double = __pytra_float((__pytra_float(1.0) / __pytra_float(scala.math.sqrt(__pytra_float((__pytra_float((__pytra_float((__pytra_float(dx) * __pytra_float(dx))) + __pytra_float((__pytra_float(dy) * __pytra_float(dy))))) + __pytra_float((__pytra_float(dz) * __pytra_float(dz)))))))))
                                                    dx *= inv_len
                                                    dy *= inv_len
                                                    dz *= inv_len
