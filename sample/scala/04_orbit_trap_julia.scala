...
def render_orbit_trap_julia(width: Long, height: Long, max_iter: Long, cx: Double, cy: Double): mutable.ArrayBuffer[Any] = {
...
def run_04_orbit_trap_julia(): Unit = {
    ...
    var pixels: mutable.ArrayBuffer[Any] = __pytra_as_list(render_orbit_trap_julia(width, height, max_iter, (-0.7269), 0.1889))
