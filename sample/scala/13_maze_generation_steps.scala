                    ...
                    while ((__step_5 >= 0L && x < __pytra_int(w)) || (__step_5 < 0L && x > __pytra_int(w))) {
                        boundary:
                            ...
                            boundary:
                                ...
                                while ((__step_8 >= 0L && yy < __pytra_int(scale)) || (__step_8 < 0L && yy > __pytra_int(scale))) {
                                    boundary:
                                        ...
                                        boundary:
                                            ...
                                            while ((__step_11 >= 0L && xx < __pytra_int(scale)) || (__step_11 < 0L && xx > __pytra_int(scale))) {
                                                boundary:
...
def run_13_maze_generation_steps(): Unit = {
        ...
        while ((__pytra_len(stack) != 0L)) {
            boundary:
                ...
                boundary:
                    given __breakLabel_3: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                    val __step_5 = __pytra_int(1L)
                    while ((__step_5 >= 0L && k < __pytra_int(4L)) || (__step_5 < 0L && k > __pytra_int(4L))) {
                        boundary:
                            given __continueLabel_4: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                            ...
                            if (((__pytra_int(nx) >= __pytra_int(1L)) && (__pytra_int(nx) < __pytra_int((__pytra_int(cell_w) - __pytra_int(1L)))) && (__pytra_int(ny) >= __pytra_int(1L)) && (__pytra_int(ny) < __pytra_int((__pytra_int(cell_h) - __pytra_int(1L)))) && (__pytra_int(__pytra_int(__pytra_get_index(__pytra_as_list(__pytra_get_index(grid, ny)), nx))) == __pytra_int(1L)))) {
                                if ((__pytra_int(dx) == __pytra_int(2L))) {
                                    candidates = __pytra_as_list(candidates); candidates.append(mutable.ArrayBuffer[Any](nx, ny, (x + 1L), y))
                                } else {
                                    if ((__pytra_int(dx) == __pytra_int((-2L)))) {
                                        candidates = __pytra_as_list(candidates); candidates.append(mutable.ArrayBuffer[Any](nx, ny, (x - 1L), y))
                                    } else {
                                        if ((__pytra_int(dy) == __pytra_int(2L))) {
                                            candidates = __pytra_as_list(candidates); candidates.append(mutable.ArrayBuffer[Any](nx, ny, x, (y + 1L)))
                                        } else {
                                            candidates = __pytra_as_list(candidates); candidates.append(mutable.ArrayBuffer[Any](nx, ny, x, (y - 1L)))
                                        }
                                    }
                ...
                if ((__pytra_int(__pytra_len(candidates)) == __pytra_int(0L))) {
                    ...
                    var sel: mutable.ArrayBuffer[Any] = __pytra_as_list(__pytra_as_list(__pytra_get_index(candidates, (__pytra_int((((x * 17L) + (y * 29L)) + (__pytra_int(__pytra_len(stack)) * __pytra_int(13L)))) % __pytra_int(__pytra_len(candidates))))))
                    ...
                    stack = __pytra_as_list(stack); stack.append(mutable.ArrayBuffer[Any](nx, ny))
                }
    ...
    frames = __pytra_as_list(frames); frames.append(capture(grid, cell_w, cell_h, scale))
    __pytra_save_gif(out_path, (__pytra_int(cell_w) * __pytra_int(scale)), (__pytra_int(cell_h) * __pytra_int(scale)), frames, __pytra_grayscale_palette())
