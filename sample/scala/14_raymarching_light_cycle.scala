...
def scene(x: Double, y: Double, light_x: Double, light_y: Double): Long = {
    ...
    var r1: Double = __pytra_float(scala.math.sqrt(__pytra_float((__pytra_float((__pytra_float(x1) * __pytra_float(x1))) + __pytra_float((__pytra_float(y1) * __pytra_float(y1)))))))
    var r2: Double = __pytra_float(scala.math.sqrt(__pytra_float((__pytra_float((__pytra_float(x2) * __pytra_float(x2))) + __pytra_float((__pytra_float(y2) * __pytra_float(y2)))))))
    ...
    var l: Double = __pytra_float(scala.math.sqrt(__pytra_float((__pytra_float((__pytra_float(lx) * __pytra_float(lx))) + __pytra_float((__pytra_float(ly) * __pytra_float(ly)))))))
                    ...
                    while ((__step_5 >= 0L && y < __pytra_int(h)) || (__step_5 < 0L && y > __pytra_int(h))) {
                        boundary:
                            ...
                            boundary:
                                ...
                                while ((__step_8 >= 0L && x < __pytra_int(w)) || (__step_8 < 0L && x > __pytra_int(w))) {
                                    boundary:
