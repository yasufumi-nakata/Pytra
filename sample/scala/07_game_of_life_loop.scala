        ...
        while ((__step_2 >= 0L && y < __pytra_int(h)) || (__step_2 < 0L && y > __pytra_int(h))) {
            boundary:
                ...
                boundary:
                    ...
                    while ((__step_5 >= 0L && x < __pytra_int(w)) || (__step_5 < 0L && x > __pytra_int(w))) {
                        boundary:
                            ...
                            boundary:
                                ...
                                while ((__step_8 >= 0L && dy < __pytra_int(2L)) || (__step_8 < 0L && dy > __pytra_int(2L))) {
                                    boundary:
                                        ...
                                        boundary:
                                            ...
                                            while ((__step_11 >= 0L && dx < __pytra_int(2L)) || (__step_11 < 0L && dx > __pytra_int(2L))) {
                                                boundary:
                            ...
                            if (((__pytra_int(alive) == __pytra_int(1L)) && ((__pytra_int(cnt) == __pytra_int(2L)) || (__pytra_int(cnt) == __pytra_int(3L))))) {
                                row = __pytra_as_list(row); row.append(1L)
                            } else {
                                if (((__pytra_int(alive) == __pytra_int(0L)) && (__pytra_int(cnt) == __pytra_int(3L)))) {
                                    row = __pytra_as_list(row); row.append(1L)
                                } else {
                                    row = __pytra_as_list(row); row.append(0L)
                                }
                            }
                        x += __step_5
                    }
                    ...
                    while ((__step_5 >= 0L && x < __pytra_int(w)) || (__step_5 < 0L && x > __pytra_int(w))) {
                        boundary:
                            ...
                            boundary:
                                given __breakLabel_6: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                                val __step_8 = __pytra_int(1L)
                                while ((__step_8 >= 0L && yy < __pytra_int(cell)) || (__step_8 < 0L && yy > __pytra_int(cell))) {
                                    boundary:
                                        given __continueLabel_7: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                                        ...
                                        boundary:
                                            given __breakLabel_9: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                                            val __step_11 = __pytra_int(1L)
                                            while ((__step_11 >= 0L && xx < __pytra_int(cell)) || (__step_11 < 0L && xx > __pytra_int(cell))) {
                                                boundary:
                                                    given __continueLabel_10: boundary.Label[Unit] = summon[boundary.Label[Unit]]
...
def run_07_game_of_life_loop(): Unit = {
    ...
    boundary:
        ...
        while ((__step_8 >= 0L && gy < __pytra_int((__pytra_int(h) - __pytra_int(8L)))) || (__step_8 < 0L && gy > __pytra_int((__pytra_int(h) - __pytra_int(8L))))) {
            boundary:
                given __continueLabel_7: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                ...
                boundary:
                    ...
                    while ((__step_11 >= 0L && gx < __pytra_int((__pytra_int(w) - __pytra_int(8L)))) || (__step_11 < 0L && gx > __pytra_int((__pytra_int(w) - __pytra_int(8L))))) {
                        boundary:
                            given __continueLabel_10: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                            ...
                            if ((__pytra_int(kind) == __pytra_int(0L))) {
                                ...
                                boundary:
                                    ...
                                    val __step_14 = __pytra_int(1L)
                                    while ((__step_14 >= 0L && py < __pytra_int(ph)) || (__step_14 < 0L && py > __pytra_int(ph))) {
                                        boundary:
                                            ...
                                            boundary:
                                                ...
                                                val __step_17 = __pytra_int(1L)
                                                while ((__step_17 >= 0L && px < __pytra_int(pw)) || (__step_17 < 0L && px > __pytra_int(pw))) {
                                                    boundary:
                                ...
                                if ((__pytra_int(kind) == __pytra_int(1L))) {
                                    ...
                                    boundary:
                                        ...
                                        val __step_20 = __pytra_int(1L)
                                        while ((__step_20 >= 0L && py < __pytra_int(ph)) || (__step_20 < 0L && py > __pytra_int(ph))) {
                                            boundary:
                                                ...
                                                boundary:
                                                    ...
                                                    val __step_23 = __pytra_int(1L)
                                                    while ((__step_23 >= 0L && px < __pytra_int(pw)) || (__step_23 < 0L && px > __pytra_int(pw))) {
                                                        boundary:
                                    ...
                                    boundary:
                                        ...
                                        val __step_26 = __pytra_int(1L)
                                        while ((__step_26 >= 0L && py < __pytra_int(ph)) || (__step_26 < 0L && py > __pytra_int(ph))) {
                                            boundary:
                                                ...
                                                boundary:
                                                    ...
                                                    val __step_29 = __pytra_int(1L)
                                                    while ((__step_29 >= 0L && px < __pytra_int(pw)) || (__step_29 < 0L && px > __pytra_int(pw))) {
                                                        boundary:
    ...
    boundary:
        ...
        val __step_32 = __pytra_int(1L)
        while ((__step_32 >= 0L && i < __pytra_int(steps)) || (__step_32 < 0L && i > __pytra_int(steps))) {
            boundary:
    ...
    __pytra_save_gif(out_path, (__pytra_int(w) * __pytra_int(cell)), (__pytra_int(h) * __pytra_int(cell)), frames, __pytra_grayscale_palette())
