...
def fire_palette(): mutable.ArrayBuffer[Any] = {
                ...
                boundary:
                    ...
                    while (x < __pytra_int(w)) {
                        boundary:
                            ...
                            __pytra_set_index(__pytra_as_list(__pytra_get_index(heat, (h - 1L))), x, py_val)
                        x += 1L
                    }
                var y: Long = __pytra_int(1L)
                boundary:
                            ...
                            boundary:
                                ...
                                while (x < __pytra_int(w)) {
                                    boundary:
                                        ...
                                        var nv: Long = (v - cool)
                                        __pytra_set_index(__pytra_as_list(__pytra_get_index(heat, (y - 1L))), x, __pytra_ifexp((nv > 0L), nv, 0L))
                                    x += 1L
                                }
                        y += 1L
                    }
