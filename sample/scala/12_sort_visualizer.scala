...
def render(values: mutable.ArrayBuffer[Any], w: Long, h: Long): mutable.ArrayBuffer[Any] = {
    ...
    boundary:
        ...
        while ((__step_2 >= 0L && i < __pytra_int(n)) || (__step_2 < 0L && i > __pytra_int(n))) {
            boundary:
                ...
                boundary:
                    ...
                    while ((__step_5 >= 0L && y < __pytra_int(h)) || (__step_5 < 0L && y > __pytra_int(h))) {
                        boundary:
                            ...
                            boundary:
                                ...
                                while ((__step_8 >= 0L && x < __pytra_int(x1)) || (__step_8 < 0L && x > __pytra_int(x1))) {
                                    boundary:
...
def run_12_sort_visualizer(): Unit = {
    ...
    boundary:
        ...
        while ((__step_2 >= 0L && i < __pytra_int(n)) || (__step_2 < 0L && i > __pytra_int(n))) {
            boundary:
                given __continueLabel_1: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                values = __pytra_as_list(values); values.append((__pytra_int((__pytra_int((__pytra_int(i) * __pytra_int(37L))) + __pytra_int(19L))) % __pytra_int(n)))
            i += __step_2
        }
    ...
    boundary:
        given __breakLabel_3: boundary.Label[Unit] = summon[boundary.Label[Unit]]
        val __step_5 = __pytra_int(1L)
        while ((__step_5 >= 0L && i < __pytra_int(n)) || (__step_5 < 0L && i > __pytra_int(n))) {
            boundary:
                given __continueLabel_4: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                ...
                boundary:
                    given __breakLabel_6: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                    val __step_8 = __pytra_int(1L)
                    while ((__step_8 >= 0L && j < __pytra_int((__pytra_int((__pytra_int(n) - __pytra_int(i))) - __pytra_int(1L)))) || (__step_8 < 0L && j > __pytra_int((__pytra_int((__pytra_int(n) - __pytra_int(i))) - __pytra_int(1L))))) {
                        boundary:
                            given __continueLabel_7: boundary.Label[Unit] = summon[boundary.Label[Unit]]
                            if ((__pytra_int(__pytra_int(__pytra_get_index(values, j))) > __pytra_int(__pytra_int(__pytra_get_index(values, (__pytra_int(j) + __pytra_int(1L))))))) {
                                val __tuple_9 = __pytra_as_list(mutable.ArrayBuffer[Any](__pytra_int(__pytra_get_index(values, (__pytra_int(j) + __pytra_int(1L)))), __pytra_int(__pytra_get_index(values, j))))
                                __pytra_set_index(values, j, __pytra_int(__tuple_9(0)))
                                __pytra_set_index(values, (__pytra_int(j) + __pytra_int(1L)), __pytra_int(__tuple_9(1)))
