...
def main() -> int:
    """CLI 入口。"""
    parser = argparse.ArgumentParser(description="Pytra EAST -> JavaScript transpiler")
    ...
    js_ir = lower_east3_to_js_ir(east)
    js_ir = optimize_js_ir(js_ir)
    js_src = transpile_to_js(js_ir)
