"""Canonicalize runtime `range(...)` loops to static for-shape plans."""
...
class CppRangeForShapePass(CppOptimizerPass):
    """Rewrite `RuntimeIterForPlan(range(...))` to `StaticRangeForPlan`."""

    name = "CppRangeForShapePass"
    min_opt_level = 1
