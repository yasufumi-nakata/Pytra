"""Canonical backend-local contract for Lua relative-import support rollout."""
...
RELATIVE_IMPORT_LUA_SUPPORT_SCENARIOS_V1: Final[list[dict[str, object]]] = [
...
RELATIVE_IMPORT_LUA_SUPPORT_HANDOFF_V1: Final[dict[str, object]] = {
    ...
    "smoke_test_file": RELATIVE_IMPORT_LUA_SUPPORT_SMOKE_V1["smoke_test_file"],
    "backend": "lua",
    "verification_lane": RELATIVE_IMPORT_LUA_SUPPORT_BACKEND_V1["verification_lane"],
    "focused_verification_lane": RELATIVE_IMPORT_LUA_SUPPORT_BACKEND_V1[
        "focused_verification_lane"
    ],
    "current_contract_state": RELATIVE_IMPORT_LUA_SUPPORT_BACKEND_V1[
        "current_contract_state"
    ],
    "current_evidence_lane": RELATIVE_IMPORT_LUA_SUPPORT_BACKEND_V1[
        "current_evidence_lane"
    ],
    "fail_closed_lane": RELATIVE_IMPORT_LUA_SUPPORT_BACKEND_V1["fail_closed_lane"],
}


def relative_import_lua_support_parent_backend_snapshot() -> dict[str, object]:
    entry = next(
        row for row in RELATIVE_IMPORT_LONGTAIL_SUPPORT_BACKENDS_V1 if row["backend"] == "lua"
    )
    return {
