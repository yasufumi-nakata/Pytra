...
CS_STD_LANE_OWNERSHIP_V1: Final[tuple[CsStdLaneOwnershipEntry, ...]] = (
    ...
    },
    {
        ...
        "smoke_guard_needles": (
            "def test_representative_os_glob_extended_fixture_transpiles",
            "Pytra.CsModule.os",
        ),
        "rationale": "generated/std/os.cs delegates @extern host bindings to native/std/os_native.cs which wraps System.IO.Directory.",
    },
    {
        "module_name": "os_path",
        "canonical_lane": "generated/std",
        ...
        "representative_fixture": "test/fixtures/stdlib/os_glob_extended.py",
        "smoke_guard_needles": (
            "def test_representative_os_path_transpiles",
            "Pytra.CsModule.os_path",
        ),
        "rationale": "generated/std/os_path.cs delegates @extern host bindings to native/std/os_path_native.cs which wraps System.IO.Path.",
    },
    {
        "module_name": "sys",
        "canonical_lane": "generated/std",
        ...
        "rationale": "generated/std/sys.cs delegates @extern host bindings to native/std/sys_native.cs which wraps System.Environment and System.Console.",
    },
    {
        "module_name": "timeit",
        "canonical_lane": "no_runtime_module",
...
RS_STD_LANE_OWNERSHIP_V1: Final[tuple[RsStdLaneOwnershipEntry, ...]] = (
    ...
    },
    {
        ...
        "rationale": "generated/std/math.rs remains the live Rust math owner, but its extern-marked surface now delegates through native/std/math_native.rs so Rust stdlib bindings stay out of generated code.",
    },
    {
        "module_name": "pathlib",
        "canonical_lane": "no_runtime_module",
