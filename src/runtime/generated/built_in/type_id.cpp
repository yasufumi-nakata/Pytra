...
namespace pytra::built_in::type_id {
    ...
    Object<list<int64>> _make_int_list_0() {
        Object<list<int64>> out = rc_list_from_value(list<int64>{});
        return out;
    }
    
    Object<list<int64>> _make_int_list_1(int64 a0) {
        Object<list<int64>> out = rc_list_from_value(list<int64>{});
        rc_list_ref(out).append(a0);
        return out;
    }
    
    bool _contains_int(const Object<list<int64>>& items, int64 value) {
        int64 i = 0;
    ...
    Object<list<int64>> _copy_int_list(const Object<list<int64>>& items) {
        Object<list<int64>> out = rc_list_from_value(list<int64>{});
        int64 i = 0;
        while (i < (rc_list_ref(items)).size()) {
    ...
    Object<list<int64>> _sorted_ints(const Object<list<int64>>& items) {
        Object<list<int64>> out = _copy_int_list(items);
        int64 i = 0;
    ...
    void _register_type_node(int64 type_id, int64 base_type_id) {
        ...
        Object<list<int64>> children = rc_list_from_value(([&]() { auto&& __dict_1 = _TYPE_CHILDREN; auto __dict_key_2 = base_type_id; return __dict_1.at(__dict_key_2); }()));
    ...
    Object<list<int64>> _sorted_child_type_ids(int64 type_id) {
        Object<list<int64>> children = _make_int_list_0();
        if (py_contains(_TYPE_CHILDREN, type_id))
    ...
    Object<list<int64>> _collect_root_type_ids() {
        Object<list<int64>> roots = rc_list_from_value(list<int64>{});
        int64 i = 0;
    ...
    int64 _assign_type_ranges_dfs(int64 type_id, int64 next_order) {
        ...
        Object<list<int64>> children = _sorted_child_type_ids(type_id);
        int64 i = 0;
    ...
    void _recompute_type_ranges() {
        ...
        int64 next_order = 0;
        Object<list<int64>> roots = _collect_root_type_ids();
        int64 i = 0;
        while (i < (rc_list_ref(roots)).size()) {
            next_order = _assign_type_ranges_dfs(py_list_at_ref(rc_list_ref(roots), i), next_order);
            i++;
        }
        Object<list<int64>> all_ids = _sorted_ints(rc_list_from_value(_TYPE_IDS));
        i = 0;
