...
<a href="../../docs-ja/spec/spec-boxing.md">
...
補足:
- `py_to_int64` / `py_to<int64>` は互換ラッパであり、変換不能値に対して `0` を返す実装を許容する。
- 厳密検証が必要な経路は `obj_to_int64_or_raise` を使う。
...
- `docs-ja/plans/p3-microgpt-source-preservation.md`
