...
| Relative import (`from .m import x`) | supported | Sibling and parent relative `from-import` are supported. Root-escape cases that climb above the entry root stay fail-closed with `input_invalid(kind=relative_import_escape)`. | `test/unit/tooling/test_py2x_cli.py:67`, `test/unit/tooling/test_py2x_cli.py:90`, `test/unit/backends/cpp/test_py2cpp_features.py:2248`, `test/unit/backends/cpp/test_py2cpp_features.py:2283` |
