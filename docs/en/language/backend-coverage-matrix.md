...
- [backend-parity-matrix.md](./backend-parity-matrix.md) remains the canonical support-claim surface.
- [backend-test-matrix.md](./backend-test-matrix.md) remains the canonical backend-owned suite-health surface.
