<a href="../../ja/plans/p0-cpp-s18-samecast-chain-reduction.md"><img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-2563EB?style=flat-square"></a>

> [!WARNING]
> This file is synchronized from `docs/ja/plans/p0-cpp-s18-samecast-chain-reduction.md` and still requires manual English translation.

> Source of truth: `docs/ja/plans/p0-cpp-s18-samecast-chain-reduction.md`
