<a href="../../ja/plans/p0-sidecar-full-removal.md"><img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-2563EB?style=flat-square"></a>

> [!WARNING]
> This file is synchronized from `docs/ja/plans/p0-sidecar-full-removal.md` and still requires manual English translation.

> Source of truth: `docs/ja/plans/p0-sidecar-full-removal.md`
...
- `docs/ja/how-to-use.md` / `docs/ja/spec/spec-import.md` / 関連 spec と `docs/en/` 翻訳
...
- `docs/ja/` / `docs/en/` から sidecar 手順・互換モード記述が撤去される。
...
- [x] [ID: P0-SIDECAR-REMOVE-01-S3-02] `docs/en/` 翻訳同期を反映し、日英で sidecar 記述の不整合を解消する。
