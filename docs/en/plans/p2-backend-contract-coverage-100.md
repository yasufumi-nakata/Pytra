...
- [ ] [ID: P2-BACKEND-CONTRACT-COVERAGE-100-01-S3-01] Sync docs, exports, checkers, and the English mirror so new features/suites fail fast when coverage mapping is missing.
