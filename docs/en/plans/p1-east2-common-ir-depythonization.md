<a href="../../ja/plans/p1-east2-common-ir-depythonization.md"><img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-2563EB?style=flat-square"></a>

> [!WARNING]
> This file is synchronized from `docs/ja/plans/p1-east2-common-ir-depythonization.md` and still requires manual English translation.

> Source of truth: `docs/ja/plans/p1-east2-common-ir-depythonization.md`
...
- [x] [ID: P1-EAST2-COMMON-IR-01-S3-01] EAST2 への Python 依存再混入を検知する unit 回帰を追加する。
- [x] [ID: P1-EAST2-COMMON-IR-01-S3-02] transpile/smoke/parity 代表ケースで非退行を確認し、決定ログへ記録する。
