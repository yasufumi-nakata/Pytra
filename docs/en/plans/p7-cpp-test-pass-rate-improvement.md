<a href="../../ja/plans/p7-cpp-test-pass-rate-improvement.md"><img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-DC2626?style=flat-square"></a>
...
union_basic, optional_none, union_list_mixed, union_dict_items が SEGV または誤出力。
...
| Any runtime | 1 | union_basic (SEGFAULT — type_id link 解消後も runtime crash) |
