<a href="../../ja/spec/spec-options.md">
...
- Must stay consistent with existing specification (`docs/en/spec/spec-dev.md`), so update both simultaneously when introducing options.
