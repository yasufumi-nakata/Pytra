<a href="../../ja/spec/spec-east2.md"><img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-2563EB?style=flat-square"></a>

> [!WARNING]
> This file is synchronized from `docs/ja/spec/spec-east2.md` and still requires manual English translation.

> Source of truth: `docs/ja/spec/spec-east2.md`
