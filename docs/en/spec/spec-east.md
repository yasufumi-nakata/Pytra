...
Notes:
- Progress tracking per phase is maintained in `docs/en/todo/index.md`.
- Detailed implementation split (emitter/profile/hooks) follows `docs/en/spec/spec-dev.md`.
