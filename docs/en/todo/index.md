...
4. [ ] [ID: P1-IR-EXPR-MODULE-DECOMPOSITION-01-S2-01] Split the `attr suffix` / `subscript suffix` cluster into dedicated modules and shrink postfix dispatch to a thin facade.
