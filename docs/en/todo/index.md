...
- [ ] [ID: P0-NONCPP-RUNTIME-GENERATED-CPP-BASELINE-01] Align non-C++ generated runtime lanes to the `cpp/generated/{built_in,std,utils}` baseline. Progress: by `S1-02`, the live 25-module baseline and the legacy exception debt inventory on top of that baseline are locked through the contract / checker / unit test. Next: materialize the missing `rs/cs` generated `std/utils` baseline and remove the `native_canonical` / `no_runtime_module` exceptions. Context: [p0-noncpp-runtime-generated-cpp-baseline.md](../plans/p0-noncpp-runtime-generated-cpp-baseline.md)
