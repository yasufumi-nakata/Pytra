...
- [ ] [ID: P0-NONCPP-RUNTIME-PYTRA-DESHIM-01-S1-02] Switch active contracts / checkers / spec wording to `generated/native only` and make checked-in `pytra/**` re-entry fail fast. Progress: the fifth bundle flipped the `rollout_remaining_contract` lane ownership to `delete_target`. The schema-level `target_roots=("generated","native","pytra")` and `compat_*` field names still remain.
