...
- [ ] [ID: P0-NONCPP-RUNTIME-GENERATED-CPP-BASELINE-01] Align non-C++ generated runtime lanes to the `cpp/generated/{built_in,std,utils}` baseline. Progress: `S2-01` is complete; `rs/cs` now materialize `generated/std/{argparse,json,random,re,sys,timeit}` and `generated/utils/assertions`. In addition, `S2-02` materialized the full 25-module `generated/{built_in,std,utils}` baseline for Java, Go, Swift, and Nim, and renamed Kotlin / Scala / Swift / Nim `utils/{gif,png}` helper-shaped outputs to canonical basenames while syncing the current/target/module-bucket checkers. Next: close the remaining full-baseline gaps in Kotlin / Scala. Context: [p0-noncpp-runtime-generated-cpp-baseline.md](../plans/p0-noncpp-runtime-generated-cpp-baseline.md)
