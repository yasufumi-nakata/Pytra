...
2. [ ] [ID: P1-HOST-CPP-EMITTER-NIM-S2] C++ emitter host parity PASS を確認し、結果を `.parity-results/emitter_host_nim.json` に書き込む（`gen_backend_progress.py` で emitter host マトリクスに反映される）
