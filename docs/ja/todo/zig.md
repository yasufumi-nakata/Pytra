...
2. [ ] [ID: P1-HOST-CPP-EMITTER-ZIG-S2] `python3 tools/run/run_emitter_host_parity.py --host-lang zig --hosted-emitter cpp --case-root fixture` で C++ emitter host parity PASS を確認する（結果は `.parity-results/emitter_host_zig.json` に自動書き込み）
