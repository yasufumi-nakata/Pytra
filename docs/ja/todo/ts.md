...
最終更新: 2026-03-30（S1/S2/S3/S4/S5 完了、P0-TS-LINT-FIX 完了、P0-TS-TYPE-MAPPING 完了、P8-TS-EMITTER-S6/S7 完了）
...
1. [ ] [ID: P0-JS-RUNTIME-ESM-S1] `py_runtime.js` の `require("fs")` / `require("path")` を ESM の `import` に書き換える
2. [ ] [ID: P0-JS-RUNTIME-ESM-S2] `os_glob_extended` fixture が JS で compile + run parity PASS することを確認する
...
7. [x] [ID: P8-TS-EMITTER-S7] fixture + sample の JS run parity を通す（node 実行）— 147/147 PASS（2026-03-30）
