...
- 進捗メモ: [ID: P1-EAST-TYPEEXPR-01-S4-01] `S3-02` で `sync_type_expr_mirrors()` を導入し、selfhost/EAST2/EAST3/linker gate で mirror drift を fail-fast にした。次は lowering が optional / dynamic union / nominal ADT を別 lane に分ける。
