...
- [ ] [ID: P0-PYTRA-NES2-CROSSBACKEND-REPRO-01] Pytra-NES2 repro を全 backend representative contract に昇格する。進捗: `S2-01` で `cpp` の current compile-failure baseline と `cs/rs/go/java/kotlin/scala/swift/nim` representative transpile smoke を固定し、`S2-02` で script family (`js/ts/lua/ruby/php`) も representative transpile smoke へ接続し、`S2-03` で全 backend 共通の representative escape denylist helper を導入して `unsupported / preview_only / not_implemented` 逃がしを fail-fast 化し、`S3-01` で `property_method_call` を全 backend green にし、`S3-02` で C++ `list[bool]` lane を `std::vector<bool>` proxy-safe にして `list_bool_index` も全 backend green にした。次は `materials/refs` と fixture/test の最終対応を同期して bundle を close する。文脈: [p0-pytra-nes2-crossbackend-repro-contract.md](../plans/p0-pytra-nes2-crossbackend-repro-contract.md)
- [ ] [ID: P0-NONCPP-RUNTIME-GENERATED-CPP-BASELINE-01] non-C++ runtime generated lane を `cpp/generated/{built_in,std,utils}` baseline に揃える。進捗: 新規起票。`generated/native` 語彙合わせではなく、`cpp/generated` と同じ module set を各 backend の `generated/` に materialize し、それを canonical owner とする方針へ引き上げる。`P0-NONCPP-RUNTIME-PYTRA-DESHIM-01` はこの task の後続とする。文脈: [p0-noncpp-runtime-generated-cpp-baseline.md](../plans/p0-noncpp-runtime-generated-cpp-baseline.md)
