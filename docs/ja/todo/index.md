...
#### P0-2: runtime .east を link パイプラインに統合（最優先）
...
4. [ ] [ID: P0-RUNTIME-EAST-IN-LINK-PIPELINE-01-S4] pathlib repro が `out/cpp/` で g++ ビルドできることを検証する。

#### P0-3: object = tagged value 統一
...
#### P0-6: tagged union を object + type_id に統一（P0-2 に包含）
