...
- [ ] [ID: P0-NONCPP-RUNTIME-GENERATED-CPP-BASELINE-01] non-C++ runtime generated lane を `cpp/generated/{built_in,std,utils}` baseline に揃える。進捗: `S2-01` を完了し、`rs/cs` の `generated/std/{argparse,json,random,re,sys,timeit}` と `generated/utils/assertions` を materialize した。さらに `S2-02` で Java と Go の `generated/{built_in,std,utils}` 25-module baseline を materialize し、Kotlin / Scala / Swift / Nim の `utils/{gif,png}` helper-shaped naming を canonical basename に寄せて current/target/module-bucket checker を同期した。次は Kotlin / Scala / Swift / Nim の full-baseline 残差を埋める。文脈: [p0-noncpp-runtime-generated-cpp-baseline.md](../plans/p0-noncpp-runtime-generated-cpp-baseline.md)
