...
最終更新: 2026-04-01（P1-LUA-EMITTER-S6 完了、P2-LUA-LINT-S1 完了、fixture parity 継続中）
...
5. [ ] [ID: P1-LUA-EMITTER-S5] fixture + sample の Lua run parity を通す（`lua5.4`）— 2026-04-01 時点で fixture `109/136 pass`。残差は comprehension/range、exception、dict/set wrapper、`isinstance_narrowing`、`staticmethod` など
