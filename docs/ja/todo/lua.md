...
最終更新: 2026-04-01（Lua fixture 137/137、stdlib 16/16、sample 1/18）
...
5. [ ] [ID: P1-LUA-EMITTER-S5] fixture + sample の Lua run parity を通す（`lua5.4`）— 2026-04-01 現在 `fixture 137/137 pass`、`stdlib 16/16 pass`。今回 `class_tuple_assign`, `ok_lambda_default`, `str_repr_containers`, `math_path_runtime_ir` を回復。sample は `1/18 pass` で、残差は syntax error 系（`03_julia_set`, `04_orbit_trap_julia`, `05_mandelbrot_zoom`, `06_julia_parameter_sweep`, `12_sort_visualizer`, `18_mini_language_interpreter`）、row/base nil 系（`07_game_of_life_loop`, `08_langtons_ant`, `09_fire_simulation`, `10_plasma_effect`, `13_maze_generation_steps`, `14_raymarching_light_cycle`, `15_wave_interference_loop`, `16_glass_sculpture_chaos`, `11_lissajous_particles`）、artifact missing（`01_mandelbrot`, `02_raytrace_spheres`）
