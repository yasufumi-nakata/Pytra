...
最終更新: 2026-04-01（Lua fixture 125/137、stdlib 16/16、sample 再計測中）
...
5. [ ] [ID: P1-LUA-EMITTER-S5] fixture + sample の Lua run parity を通す（`lua5.4`）— 2026-04-01 現在の fixture は `125/137 pass`。今回 `boolop_value_select`, `bytes_truthiness`, `class_inherit_basic`, `comprehension_dict_set`, `comprehension_if_chain`, `deque_basic`, `in_membership_iterable`, `isinstance_tuple_check`, `isinstance_user_class`, `property_method_call`, `tuple_unpack_variants`, `union_basic`, `union_dict_items` を回復。残差は `class_tuple_assign`, `exception_bare_reraise`, `reversed_enumerate`, `str_index_char_compare`, `ok_class_inline_method`, `ok_fstring_format_spec`, `ok_lambda_default`, `callable_higher_order`, `object_container_access`, `str_repr_containers`。sample は再計測中
