...
1. [ ] [ID: P2-TOP100-LANGUAGE-COVERAGE-S1] 外部 Top100 source snapshot を固定し、取得日・URL・保存場所を記録する
...
2. [ ] [ID: P2-TOP100-LANGUAGE-COVERAGE-S2] 100 言語を `backend` / `host` / `interop` / `syntax` / `defer` に分類する
