...
| 相対 import（`from .m import x`） | supported | sibling / parent relative `from-import` はサポート済み。entry root を越える root escape は `input_invalid(kind=unsupported_import_form)` で fail-closed。 | `test/unit/tooling/test_py2x_cli.py:67`, `test/unit/tooling/test_py2x_cli.py:90`, `test/unit/backends/cpp/test_py2cpp_features.py:2248`, `test/unit/backends/cpp/test_py2cpp_features.py:2283` |
