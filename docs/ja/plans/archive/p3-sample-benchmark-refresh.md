...
受け入れ基準:
- `readme.md` と `docs/ja/README.md` の実行時間表が、現行サンプル構成（01〜18）と一致している。
...
- 2026-02-25: `P3-SB-01-S4` 実施方針を確定。JS/TS と Python の最新値を `readme.md` / `docs/ja/README.md` の比較表に反映し、未測定言語を注記として記録する。
...
- [x] [ID: P3-SB-01-S4] 計測データを `readme.md` / `docs/ja/README.md` の比較表に反映し、未計測言語の注記を追加する。
