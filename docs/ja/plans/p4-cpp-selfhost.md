...
- 2026-04-26: S5 を完了。`src/pytra-cli.py` 全体を C++ emit し、runtime sources 11 件込みで `g++ -O0 -std=c++20` link が成功して `work/selfhost/bin/cpp` を生成。`./work/selfhost/bin/cpp --help` も終了コード 0。
