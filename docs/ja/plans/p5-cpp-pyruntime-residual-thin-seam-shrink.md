...
- [ ] [ID: P5-CPP-PYRUNTIME-RESIDUAL-THIN-SEAM-SHRINK-01-S1-01] current header surface と cross-runtime residual caller の baseline を docs / tooling / inventory で固定する。
