...
- 2026-03-08 snapshot では `js/ts` が green、`cs` が `toolchain_missing`、`rs/go/java/scala/lua` が `target_smoke_fail`、`kotlin/swift/ruby/php/nim` が `transpile_fail` を primary failure とする。
