...
## 相対 `from-import` の扱い（Stage 1 static normalize）
...
- 第一段階では relative `from-import`（`from .m import x`, `from ..pkg import y`, `from .. import helper`, `from . import x`, `from .m import *`）も受理し、frontend で absolute `module_id` へ正規化する。
