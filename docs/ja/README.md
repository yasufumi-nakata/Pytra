...
> **2026-03-07 | v0.9.0 リリース**<br>
> バージョン 0.9.0 リリース、大規模リファクタリングが完了し、全言語で再び使えるようになりました。<br>
> `@extern` と `@abi` を使えるようになり、変換後のコードを他言語からも呼び出せるようになりました。

> **2026-03-06 | v0.8.0 リリース**<br>
