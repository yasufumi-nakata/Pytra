...
| All docs | [English docs](../en/index.md) | [日本語ドキュメント](./index.md) |
...
> **2026-03-25** — P0 全完了。test/ ディレクトリ再編。Go emitter + runtime で sample 18/18 parity 達成。
