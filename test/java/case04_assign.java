...
public class case04_assign {
    static Object square_plus_one(Object n) {
        Object result = PyRuntime.pyMul(n, n);
        result = PyRuntime.pyAdd(result, 1);
        return result;
    }

    public static void main(String[] args) {
        PyRuntime.pyPrint(square_plus_one(5));
    }
}
