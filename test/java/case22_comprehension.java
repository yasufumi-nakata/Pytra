...
public class case22_comprehension {
    static Object comp_like_24(Object x) {
        Object values = PyRuntime.pyListFromIter(PyRuntime.pyList(1, 2, 3, 4));
        return PyRuntime.pyAdd(x, 1);
    }

    public static void main(String[] args) {
        PyRuntime.pyPrint(comp_like_24(5));
    }
}
