...
public class case19_try_raise {
    static Object maybe_fail_19(Object flag) {
        try {
            if (PyRuntime.pyBool(flag)) {
                throw new RuntimeException(PyRuntime.pyToString("fail-19"));
            }
            return 10;
        }
    ...
    public static void main(String[] args) {
        PyRuntime.pyPrint(maybe_fail_19(true));
    }
}
