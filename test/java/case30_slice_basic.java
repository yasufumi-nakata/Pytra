...
public class case30_slice_basic {
    static Object main() {
        Object nums = PyRuntime.pyList(10, 20, 30, 40, 50);
        Object text = "abcdef";
        Object mid_nums = PyRuntime.pySlice(nums, 1, 4);
        Object mid_text = PyRuntime.pySlice(text, 2, 5);
        PyRuntime.pyPrint(PyRuntime.pyGet(mid_nums, 0));
        PyRuntime.pyPrint(PyRuntime.pyGet(mid_nums, 2));
        PyRuntime.pyPrint(mid_text);
        return null;
    }
