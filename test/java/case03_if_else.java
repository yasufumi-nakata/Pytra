...
public class case03_if_else {
    static Object abs_like(Object n) {
        if (PyRuntime.pyBool(PyRuntime.pyLt(n, 0))) {
            return PyRuntime.pyNeg(n);
        } else {
            return n;
        }
    }
    ...
    public static void main(String[] args) {
        PyRuntime.pyPrint(abs_like(PyRuntime.pyNeg(12)));
    }
}
