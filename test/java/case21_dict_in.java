...
public class case21_dict_in {
    static Object has_key_23(Object k) {
        Object d = PyRuntime.pyDict("a", 1, "b", 2);
        if (PyRuntime.pyBool(PyRuntime.pyIn(k, d))) {
            return true;
        } else {
            return false;
        }
    ...
    public static void main(String[] args) {
        PyRuntime.pyPrint(has_key_23("a"));
    }
}
