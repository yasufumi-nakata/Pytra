...
public class case12_string_ops {
    static Object decorate(Object name) {
        Object prefix = "[USER] ";
        Object message = PyRuntime.pyAdd(prefix, name);
        return PyRuntime.pyAdd(message, "!");
    }

    public static void main(String[] args) {
        PyRuntime.pyPrint(decorate("Alice"));
    }
}
