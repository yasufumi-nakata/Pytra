...
public class case26_dataclass {
    static Map<Object, Object> __cls_Point99 = PyRuntime.pyDict();
    static Map<Object, Object> NewPoint99(Object... __args) {
        Map<Object, Object> self = PyRuntime.pyDict("__class", "Point99");
        Object x = null;
        if (__args.length > 0) { x = __args[0]; }
        self.put("x", x);
        Object y = 10;
        if (__args.length > 1) { y = __args[1]; }
        self.put("y", y);
        return self;
    }
    static Object Point99_total(Map<Object, Object> self) {
        return PyRuntime.pyAdd(PyRuntime.pyGet(self, "x"), PyRuntime.pyGet(self, "y"));
    }

    public static void main(String[] args) {
        Object p = NewPoint99(3);
        PyRuntime.pyPrint(Point99_total((Map<Object, Object>)p));
    }
}
