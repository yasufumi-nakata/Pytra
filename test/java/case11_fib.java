...
public class case11_fib {
    static Object fib(Object n) {
        if (PyRuntime.pyBool(PyRuntime.pyLe(n, 1))) {
            return n;
        }
        return PyRuntime.pyAdd(fib(PyRuntime.pySub(n, 1)), fib(PyRuntime.pySub(n, 2)));
    }

    public static void main(String[] args) {
        PyRuntime.pyPrint(fib(10));
    }
}
