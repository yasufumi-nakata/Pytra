...
public class case15_class_member {
    static Map<Object, Object> __cls_Counter = PyRuntime.pyDict("value", 0);
    static Map<Object, Object> NewCounter() {
        Map<Object, Object> self = PyRuntime.pyDict("__class", "Counter");
        return self;
    }
    static Object Counter_inc(Map<Object, Object> self) {
        PyRuntime.pySet(__cls_Counter, "value", PyRuntime.pyAdd(PyRuntime.pyGet(__cls_Counter, "value"), 1));
        return PyRuntime.pyGet(__cls_Counter, "value");
    }

    public static void main(String[] args) {
        Object c = NewCounter();
        PyRuntime.pyPrint(Counter_inc((Map<Object, Object>)c));
    }
}
