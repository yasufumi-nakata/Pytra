...
public class case25_for_range {
    static Object sum_range_29(Object n) {
        Object total = 0;
        for (Object __pytra_it_1 : PyRuntime.pyRange(PyRuntime.pyToInt(0), PyRuntime.pyToInt(n), PyRuntime.pyToInt(1))) {
            Object i = __pytra_it_1;
            total = PyRuntime.pyAdd(total, i);
        }
        return total;
    }

    public static void main(String[] args) {
        PyRuntime.pyPrint(sum_range_29(5));
    }
}
