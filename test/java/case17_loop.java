...
public class case17_loop {
    static Object calc_17(Object values) {
        Object total = 0;
        for (Object __pytra_it_1 : PyRuntime.pyIter(values)) {
            Object v = __pytra_it_1;
            if (PyRuntime.pyBool(PyRuntime.pyEq(PyRuntime.pyMod(v, 2), 0))) {
                total = PyRuntime.pyAdd(total, v);
            } else {
                total = PyRuntime.pyAdd(total, PyRuntime.pyMul(v, 2));
            }
        }
        return total;
    }
    ...
    public static void main(String[] args) {
        PyRuntime.pyPrint(calc_17(PyRuntime.pyList(1, 2, 3, 4)));
    }
}
