...
public class case27_class_instance {
    static Map<Object, Object> __cls_Box100 = PyRuntime.pyDict();
    static Map<Object, Object> NewBox100(Object seed) {
        Map<Object, Object> self = PyRuntime.pyDict("__class", "Box100");
        PyRuntime.pySet(self, "seed", seed);
        return self;
    }
    static Object Box100_next(Map<Object, Object> self) {
        PyRuntime.pySet(self, "seed", PyRuntime.pyAdd(PyRuntime.pyGet(self, "seed"), 1));
        return PyRuntime.pyGet(self, "seed");
    }

    public static void main(String[] args) {
        Object b = NewBox100(3);
        PyRuntime.pyPrint(Box100_next((Map<Object, Object>)b));
    }
}
