...
var __cls_Box100 = map[any]any{}
func NewBox100(seed any) map[any]any {
    self := map[any]any{"__class": "Box100"}
    pySet(self, "seed", seed)
    return self
}
func Box100_next(self map[any]any) any {
    pySet(self, "seed", pyAdd(pyGet(self, "seed"), 1))
    return pyGet(self, "seed")
}

func main() {
    var b any = NewBox100(3)
    _ = b
    pyPrint(Box100_next(b.(map[any]any)))
}
