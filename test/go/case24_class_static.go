...
var __cls_Counter26 = map[any]any{"total": 0}
func NewCounter26() map[any]any {
    self := map[any]any{"__class": "Counter26"}
    return self
}
func Counter26_add(self map[any]any, x any) any {
    pySet(__cls_Counter26, "total", pyAdd(pyGet(__cls_Counter26, "total"), x))
    return pyGet(__cls_Counter26, "total")
}

func main() {
    var c any = NewCounter26()
    _ = c
    pyPrint(Counter26_add(c.(map[any]any), 5))
}
