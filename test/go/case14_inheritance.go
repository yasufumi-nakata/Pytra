...
var __cls_Animal = map[any]any{}
func NewAnimal() map[any]any {
    self := map[any]any{"__class": "Animal"}
    return self
}
func Animal_sound(self map[any]any) any {
    return "generic"
}

var __cls_Dog = map[any]any{}
func NewDog() map[any]any {
    self := NewAnimal()
    self["__class"] = "Dog"
    return self
}
func Dog_bark(self map[any]any) any {
    return pyAdd(Animal_sound(self), "-bark")
}

func main() {
    var d any = NewDog()
    _ = d
    pyPrint(Dog_bark(d.(map[any]any)))
}
