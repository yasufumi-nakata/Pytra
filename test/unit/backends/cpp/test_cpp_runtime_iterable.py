...
'''
    ...
    def test_runtime_list_overload_inventory(self) -> None:
        ...
        self.assertIn("generated-runtime local lists and object-bridge callers", runtime_header)
        self.assertIn("Typed lanes must use py_list_*_mut directly.", runtime_header)
        ...
        self.assertIn("return py_tid_is_subtype(py_runtime_type_id(value), expected_type_id);", type_id_cpp)
        ...
        self.assertIn("return py_tid_is_subtype(static_cast<int64>(actual_type_id), static_cast<int64>(expected_type_id));", runtime_header)
        self.assertIn("return py_tid_issubclass(static_cast<int64>(actual_type_id), static_cast<int64>(expected_type_id));", runtime_header)
        self.assertIn("return py_tid_isinstance(value, static_cast<int64>(expected_type_id));", runtime_header)
        self.assertIn(
