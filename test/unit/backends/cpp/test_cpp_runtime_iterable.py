...
'''
    ...
    def test_runtime_list_overload_inventory(self) -> None:
        ...
        self.assertIn("static inline str py_dict_get_default(const dict<str, str>& d, const char* key, const char* defval)", runtime_header)
        self.assertIn("static inline str py_dict_get_default(const dict<str, str>& d, const str& key, const char* defval)", runtime_header)
