...
class PytraCliProfilesTest(unittest.TestCase):
    ...
    def test_make_noncpp_build_plan_cs_uses_generated_time_math_json_and_pathlib_lanes(self) -> None:
        ...
        self.assertNotIn(str(ROOT / "src/runtime/cs/native/std/json.cs"), plan.build_cmd)
        self.assertNotIn(str(ROOT / "src/runtime/cs/native/std/pathlib.cs"), plan.build_cmd)
