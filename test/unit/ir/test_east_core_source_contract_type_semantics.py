...
class EastCoreSourceContractTypeSemanticsTest(unittest.TestCase):
    def test_core_source_moves_type_helper_cluster_out_of_core(self) -> None:
        ...
        self.assertIn("from toolchain.ir.core_type_semantics import _sh_default_type_aliases", core_text)
        self.assertIn("from toolchain.ir.core_type_semantics import _sh_is_type_expr_text", core_text)
        self.assertIn("from toolchain.ir.core_type_semantics import _sh_typing_alias_to_type_name", core_text)
