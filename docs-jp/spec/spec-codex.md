...
- `README.md` からリンクされるドキュメント（`docs-jp/how-to-use.md`, `docs-jp/spec/spec-sample-code.md`, `docs-jp/spec/index.md`, `docs-jp/plans/pytra-wip.md`, `docs-jp/spec/spec-philosophy.md`）の整合性を確認し、必要なら同時更新します。
