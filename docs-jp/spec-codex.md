...
- 例外として、`docs-jp/plans/`、`docs-jp/language/`、`docs-jp/todo-history/` 配下は、運用ルールに沿う範囲で Codex が自律的に新規ファイルを作成してよいものとします。
...
- `tools/` にスクリプトを追加・削除・改名した場合は、`docs-jp/spec-tools.md` を同時更新します。
