...
文脈: `docs-jp/plans/archive/20260223-tg-p0-boxing.md`（`TG-P0-BOXING`）
...
文脈: `docs-jp/plans/archive/20260223-tg-p2-microgpt-compat.md`（`TG-P2-MICROGPT-COMPAT`）
...
文脈: `docs-jp/plans/archive/20260223-tg-p3-spec-drafts.md`（`TG-P3-SPEC-DRAFTS`）
...
以下を `docs-jp/todo.md` から `todo-history` へ移管（`P0-EAST123-*` へ統合クローズ）。
