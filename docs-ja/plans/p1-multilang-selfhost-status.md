...
| cs | pass | native | fail | /tmp/tmpkcnb003x/cs_selfhost_stage1.cs(18,19): error CS0246: The type or namespace name `Path' could not be found. Are you missing `System.IO' using directive? |
