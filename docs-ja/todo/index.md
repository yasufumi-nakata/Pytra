...
7. [x] [ID: P3-MSP-REVIVE-01-S3-02] 再開タスク完了時に archive へ戻すための移管条件（完了定義）を文書化する。
...
- `P3-MSP-REVIVE-01-S3-02` `docs-ja/plans/p3-microgpt-revival.md` に archive 移管条件（回帰スクリプト既定成功・2系統ユニットテスト成功・進捗ログ要件）を明文化した。
