...
|-|-|-:|-:|-:|-|-|-|
|01_mandelbrot|マンデルブロ集合（PNG）|16.175|0.706|0.719|2.549|🚧|🚧|
|02_raytrace_spheres|球の簡易レイトレーサ（PNG）|5.132|0.145|0.155|0.865|🚧|🚧|
|03_julia_set|ジュリア集合（PNG）|13.578|0.798|0.675|3.395|🚧|🚧|
|04_monte_carlo_pi|モンテカルロ法で円周率近似|10.921|0.156|0.197|0.601|🚧|🚧|
|05_mandelbrot_zoom|マンデルブロズーム（GIF）|13.802|0.535|0.539|2.694|🚧|🚧|
|06_julia_parameter_sweep|ジュリア集合パラメータ掃引（GIF）|9.825|0.396|0.387|1.929|🚧|🚧|
|07_game_of_life_loop|ライフゲーム（GIF）|13.410|0.744|0.653|3.167|🚧|🚧|
|08_langtons_ant|ラングトンのアリ（GIF）|7.431|0.504|0.453|2.233|🚧|🚧|
|09_fire_simulation|炎シミュレーション（GIF）|13.649|0.665|0.607|6.488|🚧|🚧|
|10_plasma_effect|プラズマエフェクト（GIF）|7.640|0.656|0.529|2.356|🚧|🚧|
|11_lissajous_particles|リサージュ粒子（GIF）|5.250|0.383|0.343|0.754|🚧|🚧|
|12_sort_visualizer|ソート可視化（GIF）|11.451|0.778|0.684|1.852|🚧|🚧|
|13_maze_generation_steps|迷路生成ステップ（GIF）|4.716|0.292|0.274|0.946|🚧|🚧|
|14_raymarching_light_cycle|簡易レイマーチング（GIF）|2.666|0.156|0.149|0.467|🚧|🚧|
|15_mini_language_interpreter|ミニ言語インタプリタ |2.207|0.694|1.198|1.035|🚧|🚧|
|16_glass_sculpture_chaos|ガラス彫刻のカオス回転（GIF）|7.114|0.254|0.232|1.289|🚧|🚧|
