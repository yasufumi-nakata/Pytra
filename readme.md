...
現在は Python から C++/Rust/C#/JavaScript/TypeScript への変換に対応しており、Go/Java/Swift/Kotlin は今後の対応予定です。

JavaScript / TypeScript 変換は、現時点では「埋め込み Python 実行モード」です（Node.js 上で Python ソースを実行）。
...
|ファイル名|内容|Python| C++ | Rust | C# | JS | TS |
|-|-|-:|-:|-:|-|-|-|
|01_mandelbrot|マンデルブロ集合（PNG）|16.175|0.754|0.719|2.549|16.015|16.044|
|02_raytrace_spheres|球の簡易レイトレーサ（PNG）|5.132|0.108|0.155|0.865|5.239|5.359|
|03_julia_set|ジュリア集合（PNG）|13.578|0.808|0.675|3.395|13.116|13.233|
|04_monte_carlo_pi|モンテカルロ法で円周率近似|10.921|0.161|0.197|0.601|10.807|10.931|
|05_mandelbrot_zoom|マンデルブロズーム（GIF）|13.802|0.544|0.539|2.694|15.489|14.322|
|06_julia_parameter_sweep|ジュリア集合パラメータ掃引（GIF）|9.825|0.386|0.387|1.929|9.588|9.782|
|07_game_of_life_loop|ライフゲーム（GIF）|13.645|0.692|0.722|3.272|13.641|13.656|
|08_langtons_ant|ラングトンのアリ（GIF）|7.431|0.471|0.453|2.233|7.609|7.506|
|09_fire_simulation|炎シミュレーション（GIF）|13.649|0.625|0.607|6.488|14.006|13.870|
|10_plasma_effect|プラズマエフェクト（GIF）|7.640|0.527|0.529|2.356|7.476|7.320|
|11_lissajous_particles|リサージュ粒子（GIF）|5.250|0.350|0.343|0.754|5.561|5.175|
|12_sort_visualizer|ソート可視化（GIF）|11.451|0.648|0.684|1.852|11.674|11.438|
|13_maze_generation_steps|迷路生成ステップ（GIF）|4.716|0.283|0.274|0.946|4.903|4.910|
|14_raymarching_light_cycle|簡易レイマーチング（GIF）|2.666|0.123|0.149|0.467|2.745|2.769|
|15_mini_language_interpreter|ミニ言語インタプリタ |2.207|0.600|0.789|1.035|2.403|2.360|
|16_glass_sculpture_chaos|ガラス彫刻のカオス回転（GIF）|7.114|0.205|0.231|1.289|7.457|7.538|
