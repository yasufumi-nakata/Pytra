...
- トランスパイラ自身のソースコードも本トランスパイラで他言語へ変換でき、セルフホスティングが可能です。  
...
|-|-|-:|-:|-:|-:|-:|-:|-:|-:|-:|-:|
|01 |マンデルブロ集合（PNG）|20.793| - | - | - |0.817|0.876| - | - | - | - |
|02 |球の簡易レイトレーサ（PNG）|7.607| - | - | - |0.293|0.291| - | - | - | - |
|03 |ジュリア集合（PNG）|24.485| - | - | - |1.270|1.319| - | - | - | - |
|04 |オービットトラップ Julia（PNG）|13.682| - | - | - |0.548|0.517| - | - | - | - |
|05 |マンデルブロズーム（GIF）|15.491| - | - | - |0.765|0.737| - | - | - | - |
|06 |ジュリア集合パラメータ掃引（GIF）|10.340| - | - | - |0.658|0.625| - | - | - | - |
|07 |ライフゲーム（GIF）|5.547| - | - | - |1.232|1.343| - | - | - | - |
|08 |ラングトンのアリ（GIF）|5.745| - | - | - |2.141|2.094| - | - | - | - |
|09 |炎シミュレーション（GIF）|12.693| - | - | - |2.472|2.274| - | - | - | - |
|10 |プラズマエフェクト（GIF）|7.067| - | - | - |1.381|2.565| - | - | - | - |
|11 |リサージュ粒子（GIF）|3.837| - | - | - |1.592|1.453| - | - | - | - |
|12 |ソート可視化（GIF）|4.303| - | - | - |1.540|1.533| - | - | - | - |
|13 |迷路生成ステップ（GIF）|3.830| - | - | - |0.024|0.015| - | - | - | - |
|14 |簡易レイマーチング（GIF）|3.050| - | - | - |0.530|0.834| - | - | - | - |
|15 |波干渉ループ（GIF）|2.953| - | - | - |0.677|1.119| - | - | - | - |
|16 |ガラス彫刻のカオス回転（GIF）|7.869| - | - | - |0.793|1.153| - | - | - | - |
|17 |モンテカルロ法で円周率近似（PNG）|0.325| - | - | - |0.049|0.049| - | - | - | - |
